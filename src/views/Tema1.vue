...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mt-3 ¿Cuál debe ser la actividad precisa que debe realizar el evaluado que permita la entrega del producto, servicio o resultado sobre el cual va a ser valorado su desempeño?

    .titulo-quinto.color-acento-contenido.mt-5.text-center
        h6 Ejemplo de verbos sugeridos

    .text-center.mt-4
      .col-md-9(style="margin:0 auto;")
        .row
          .col-md-4.mb-3
            .px-5.pb-5.pt-4(style="background-color:#DEE4F0;border-radius:8px;")
              ul.text-left
                li.text-left.mt-2 Actualizar
                li.text-left.mt-2 Administrar
                li.text-left.mt-2 Adquirir
                li.text-left.mt-2 Capacitar
                li.text-left.mt-2 Certificar
                li.text-left.mt-2 Clasificar
                li.text-left.mt-2 Conceptuar
                li.text-left.mt-2 Desarrollar
                li.text-left.mt-2 Diagnosticar

          .col-md-4.mb-3
            .px-5.pb-5.pt-4(style="background-color:#DEE4F0;border-radius:8px;")
              ul.text-left
                li.text-left.mt-2 Diseñar
                li.text-left.mt-2 Distribuir
                li.text-left.mt-2 Ejecutar
                li.text-left.mt-2 Elaborar
                li.text-left.mt-2 Entregar
                li.text-left.mt-2 Evaluar
                li.text-left.mt-2 Hacer
                li.text-left.mt-2 Identificar
                li.text-left.mt-2 Implementar

          .col-md-4.mb-3
            .px-5.pb-4.pt-3(style="background-color:#DEE4F0;border-radius:8px;")
              ul.text-left
                li.text-left.mt-2 Investigar
                li.text-left.mt-2 Organizar
                li.text-left.mt-2 Presentar
                li.text-left.mt-2 Presupuestar
                li.text-left.mt-2 Programar
                li.text-left.mt-2 Proyectar
                li.text-left.mt-2 Publicar
                li.text-left.mt-2 Registrar
                li.text-left.mt-2 Sistematizar
                li.text-left.mt-2 Verificar

    h6.mt-5 Objeto:

    p.mt-3 El objeto además de permitir establecer el producto, servicio o resultado que debe entregar el evaluado para cumplir con el compromiso pactado, debe responder a los siguientes interrogantes:
    ...
    h6.mt-5 Condición de resultado (oportunidad y calidad)

    p.mt-3 La condición de resultado hace alusión a los factores de calidad y oportunidad, así como, los requisitos que deben reunir los compromisos para contribuir al logro de los resultados esperados y, deben dar respuesta a las siguientes preguntas:
    ...
    .col-md-11.mt-4
      .p-4(style="background-color:#F1EAFF")
        ul.lista-ul
            ...
            li.mt-2
              i.fas.fa-check
              | ¿Con qué insumos, herramientas y condiciones debe contar el evaluado para viabilizar la realización de las actividades conducentes al cumplimiento de cada?
            li.mt-2
              i.fas.fa-check
    ...
    p.mt-5 Los compromisos funcionales están relacionados con los resultados, productos o servicios, que se evalúan de acuerdo con el cumplimiento, en un rango de 1 a 100.

    p.mt-3 Los compromisos comportamentales hacen referencia al desempeño observado de la actitud o conducta que muestra el servidor público en el desarrollo de las funciones. Estos compromisos se evalúan de acuerdo con el nivel de desarrollo de la competencia. El Decreto 815/18 define las competencias comportamentales comunes a los servidores públicos y por nivel jerárquico.
    ...
    br
    .titulo-segundo.mt-5
      #t_1_2.h4 1.2 Fase II Seguimiento

    p.mt-4 El seguimiento se refiere a la revisión del avance, cumplimiento o incumplimiento de los compromisos, durante el período de evaluación. La verificación está a cargo del evaluador, donde podrá tener en cuenta los siguientes criterios definidos en el Anexo Técnico del Acuerdo 617/18:
    ...
    p.mt-3 Las evidencias permiten soportar la calificación de cada evaluado y tanto los evaluados como los evaluadores deberán realizar la descripción de estas, en el aplicativo diseñado por la CNSC. (EDL APP) en el módulo de evidencias.
    ...
    .tabla-a.color-acento-contenido.mt-5
      ...
      table.table-striped
        ...
        tr
          td 
            p Orientación al usuario y al ciudadano (Decreto 815/18)
            p.mt-3 Conductas asociadas
          ...
          td 
            ...
            p.mt-3 (En este caso son instrumentos aplicados para medir la percepción de los usuarios en cuanto a la actitud para dirigir las decisiones y acciones en pro de la calidad del servicio)
    ...
    br
    .titulo-segundo.mt-5
      #t_1_3.h4 1.3 Fase III Evaluaciones parciales
    ...
    .row.mt-5
      .col-md-7.mb-3
        ...
        p.mt-3 Según lo establecido en el anexo técnico del Acuerdo 6176 de 2018, los compromisos funcionales se evalúan según su cumplimento en un rango de 1 a 100, independiente del peso porcentual asignado a cada compromiso, y los compromisos comportamentales se evalúan de acuerdo con el nivel de desarrollo, según escala establecida por la CNSC.

      .col-md-5
        img(src='@/assets/curso/tema1/23.svg' alt='AvatarTop')

    .col-md-9.mt-5
      .cajon.color-primario.p-5.mb-4(style="background-color:#D8FFFF")
        p Las conductas asociadas a las competencias a evaluar serán calificadas considerando tres variables: #[strong frecuencia, impacto y valor].
    ...
    .col-md-6.mt-5(style="margin:0 auto")
      .row.text-center
        .col-md-6
          p #[strong Primer Semestre]
          .p-4.mt-2(style="background-color:#D8FFFF")
            p Del 1 de febrero y el 31 de julio de cada año
        .col-md-6
          p #[strong Segundo Semestre]
          .p-4.mt-2(style="background-color:#D8FFFF")
            p Del 1 de agosto y el 31 de enero del año siguiente
    ...
    p.mt-5 Las evaluaciones parciales eventuales deben producirse dentro de los diez (10) días hábiles siguientes, contados a partir del momento en que se presente la situación que las origina, con excepción de la ocasionada por cambio de evaluador, la cual se realizará antes del retiro de éste.
    ...
    .tabla-a.color-acento-contenido.mt-5
      table
        tr
          ...
          th.text-center.tabla-b__header.text-white(style="border:none !important;") Descripción
          th.text-center.tabla-b__header.text-white(style="border:none !important;") Resultados numéricos
        tr
          td.text-center Bajo
          td.text-center El nivel de desarrollo de la competencia no se evidencia, ni tampoco se observa un impacto positivo que permita la obtención de las metas y logros esperados.
          td.text-center 4 a 6
        tr
          td.text-center Aceptable
          td.text-center El nivel de desarrollo de la competencia se evidencia con mediana frecuencia, con un impacto parcial en la obtención de las metas y logros esperados.
          td.text-center 7 a 9
        tr
          td.text-center Alto
          td.text-center El nivel de desarrollo de la competencia se evidencia de manera permanente e impacta ampliamente y de manera positiva en la obtención de las metas y logros esperados.
          td.text-center 10 a 12
        tr
          td.text-center Muy alto
          td.text-center El nivel de desarrollo de la competencia se evidencia de manera permanente, impactando amplia y positivamente la obtención de las metas y logros esperados, e igualmente agregando valor en los procesos y resultados.
          td.text-center 13 a 15

    p.mt-3 Nota. Anexo técnico del Acuerdo 6176/18

    br
    br
    .titulo-segundo.mt-5
      #t_1_4.h4 1.4 Fase IV Calificación definitiva
    ...
    p.mt-3 #[strong En la consolidación de la calificación definitiva en período anual, se debe tener en cuenta los siguientes criterios:]

    .row.mt-3
      .col-md-9.mb-3
        .p-5.mt-5(style="background-color:#F6F6F6")
          ul.lista-ul
            li
              i.fas.fa-check
      ...
      .col-md-4.mb-4
        .tarjeta-numerada.color-primario.p-5
          .tarjeta-numerada__numero
            .h4 1
          p La calificación corresponde a la sumatoria de los porcentajes que obtiene el evaluado en las evaluaciones parciales eventuales cuando se hubieren presentado.
      .col-md-4.mb-4
        .tarjeta-numerada.color-primario.p-5
          .tarjeta-numerada__numero
            .h4 2
          p Corresponde a uno de los niveles de cumplimiento de compromisos concertados, conforme a la escala de calificación definida en el artículo 10 del Acuerdo 6176 de 2018.
      .col-md-4.mb-4
        .tarjeta-numerada.color-primario.p-5
          .tarjeta-numerada__numero
            .h4 3
          p.mb-5 La calificación definitiva es independiente de las evaluaciones obtenidas con anterioridad o posterioridad a esta.
    ...
    .row.mt-2
      .col-md-4.mb-4
        .tarjeta-numerada.color-primario.p-5
          .tarjeta-numerada__numero
            .h4 4
          p El período anual de evaluación inicia al día siguiente de la firmeza de la calificación del período de prueba hasta el 31 de enero del año siguiente, siempre y cuando el lapso de prestación de servicios sea superior a treinta (30) días calendario.
      .col-md-4.mb-4
        .tarjeta-numerada.color-primario.p-5
          .tarjeta-numerada__numero
            .h4 5
          p.mb-5 En el período de prueba no procede evaluación extraordinaria.
          br
          br
          br
          br
    ...
    p.mt-3 En el Artículo 10 del Acuerdo 6176 de 2018, la escala de calificación del desempeño anual y en periodo de prueba, conforme al porcentaje que asigne el evaluador para los niveles establecidos, se define de la siguiente forma:
    ...
    .bloque-texto-a.color-secundario.p-4.p-md-5.mt-5 
      .row.m-0.align-items-center.justify-content-between
        .col-md-4.mb-4.mb-lg-0
          .h6.mb-0 Lo referente a comunicaciones y notificaciones fueron definidas en el material de formación marco normativo del sistema de evaluación de la CNSC, según el artículo 16 del Acuerdo 6176 de 2018:
        .col-md-8
          .bloque-texto-a__texto.p-5.bg-white
            p  “Las comunicaciones y notificaciones se llevarán a cabo en los términos de los artículos 33 y 34 del Decreto Ley 760 de 2005, o las disposiciones que lo modifiquen, aclaren o sustituyan”.
...
.tabla-b.color-acento-contenido .tabla-b__header, .color-acento-contenido.tabla-c .tabla-b__header
